...
describe('Update stages to version 2', () => {
  ...
  const expectedMappings = [
    ...
    { v1: EXERCISE_STAGE.SHORTLISTED, v2: EXERCISE_STAGE.SELECTION },
    { v1: EXERCISE_STAGE.SELECTED, v2: EXERCISE_STAGE.SCC },
    { v1: EXERCISE_STAGE.SELECTABLE, v2: EXERCISE_STAGE.SCC },
    { v1: EXERCISE_STAGE.RECOMMENDED, v2: EXERCISE_STAGE.RECOMMENDATION },
...
describe('Update status to version 2', () => {
  ...
  const expectedMappings = [
    ...
    { v1: APPLICATION_STATUS.SUBMITTED_FIRST_TEST, v2: '' },
