<template>
  <section>
    <form @submit.prevent="save">
      ...
      <fieldset>
        <legend>Have you ever been convicted of, cautioned for or received a conditional caution for a motoring offence (other than a parking offence)?</legend>
      ...
      <fieldset>
        <legend>Have you ever received a penalty notice?</legend>
      ...
      <fieldset>
        <legend>Have you received any fixed penalty notices in the past 4 years?</legend>
      ...
      <fieldset>
        <legend>Have you received any endorsements ordered on your licence in the past 4 years?</legend>
      ...
      <fieldset>
        <legend>Have you ever been convicted of or cautioned for a criminal offence?</legend>
      ...
      <fieldset>
        <legend>Have you ever been declared bankrupt?</legend>
      ...
      <fieldset>
        <legend>Have you ever enter into an Individual Voluntary Arrangement (IVA)?</legend>
      ...
      <fieldset>
        <legend>Have you ever been sued in relation to any debt?</legend>
      ...
      <fieldset>
        <legend>Have you ever been a director of a company that has become insolvent?</legend>
      ...
      <fieldset>
        <legend>Have you or your company ever received a penalty for any VAT or tax assessments?</legend>
      ...
      <fieldset>
        <legend>Have you or your company ever been penalised for submitting a late VAT or tax return, including through a county court?</legend>
      ...
      <fieldset>
        <legend>Have you or your company ever had a finding of professional negligence against you?</legend>
      ...
      <fieldset>
        <legend>Have you or your company ever been involved in unfair or wrongful dismissal or discrimination or any other adverse civil proceedings against you?</legend>
      ...
      <fieldset>
        <legend>Have you or your company ever had a finding of professional misconduct against you?</legend>
      ...
      <fieldset>
        <legend>Have you or your company ever had a finding of inadequate professional service against you?</legend>
      ...
      <fieldset>
        <legend>Have you ever had any other type of complaint raised against you?</legend>
      ...
      <fieldset>
        <legend>Have you ever been asked to resign, or been dismissed from, employment or judicial office?</legend>
      ...
      <fieldset>
        <legend>Is there anything else that is relevant to your character that you haven't already told us?</legend>
      ...
      <fieldset>
        <legend>Are you involved in any current investigations?</legend>
