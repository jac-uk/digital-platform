...
const NOTIFY_SCHEDULE = 'every day 05:52';
...
exports.notifyAdminsWhenExerciseOpens = functions.pubsub.schedule(NOTIFY_SCHEDULE).timeZone('Europe/London').onRun((context) => {
