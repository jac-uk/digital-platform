...
const { sendPreSelectionDayQuestionnaireNotifications } = require('../actions/applications/applications.js')(config, firebase, db, auth);
...
module.exports = functions.region('europe-west2').https.onCall(async (data, context) => {
  ...
  return await sendPreSelectionDayQuestionnaireNotifications(data);
});
