import { getDocument, getDocuments, applyUpdates, dedupeArray } from '../shared/helpers.js';
...
export default (db, auth) => {
  ...
  async function getCandidatesSinceSignInDate(specifiedCutoffDate) {
    ...
    // @TODO: FIX THIS TOO AND MOVE THESE FUNCTIONS TO A BETTER LOCATION THAN THIS FILE!!!
