...
module.exports = (firebase, db) => {
  ...
  function getHtmlEligibilityIssues(exercise, applicationRecords) {
    ...
    writer.addRaw(`
      <div style="font-weight: 700; font-size: 11pt; text-align: center; margin-top: -150px;">
        <div style="margin-top: 50px;">
          ...
          <p style="margin-top: 13px;">${day} ${month} ${year}</p>
          <h3 style="font-size: 11pt; margin-top: 28px;">Eligibility/Additional Selection [criteria / criterion] / Character Paper</h3>
          <p style="margin-top: 28px;">for</p>
          <p style="margin-top: 13px;">${exercise.referenceNumber}</p>
          <p style="margin-top: 13px;">(JAC/SCC/xx/xxx)</p>
    ...
    writer.addRaw(`
      <div style="font-family: 'Arial';">
        <p><b>Eligibility/Additional Selection [Criteria / Criterion] Paper</b></p>
        <br>
        <p style=""><b><u>Contents</u></b></p>
        <br>
        <p>
        ...
        <br>
        <p>
          <a href="#additional">Additional Selection Criteria</a>
        </p>
        <br>
        <p>
          <a href="#service">Reasonable Length of Service</a>
        </p>
        <br>
        <p>
          <a href="#service">ANNEX A</a> Judicial Appointments Eligibility Statement and ASC
        </p>
      </div>
    `);
    ...
    writer.addRaw(`
      <div style="font-family: 'Arial'; font-size: 11pt;">
        ...
        <ol>
          <li>
            <p>This paper provides information about <b>${applicationRecords.length}</b> ${applicationRecords.length > 1 ? 'candidates' : 'candidate'} for the post <b>${exercise.name}</b> and the extent to which they satisfy the Lord Chancellor's Additional Selection [<em>criteria / criterion</em>] (ASC).</p>
          </li>
        </ol>
        <br>
        ...
        <ol start="2">
          <li>
            <p>The Committee is asked to consider and agree the recommendations set out in paragraph <b>5</b> below.</p>
          </li>
        </ol>
        <br>
        <p><b>Background</b></p>
        ...
        <ol start="3">
          <li>
            <p>The Judicial Appointments Commission received a vacancy request on <span style="color: gray;">insert date</span> asking us to select <span style="color: gray;">insert number</span> candidates for appointment under section <b<span style="color: red;">&lt;insert</span></b<span style="color: red;"> 87, 94 or both<b&gt;</b</span> of the Constitutional Reform Act 2005 (CRA) <b<span style="color: red;">OR</span></b<span style="color: red;"> under section 83 Government of Wales Act 2006.</span></p>
          </li>
          <li>
            <p>The exercise launched on <span style="color: gray;">insert date</span> and closed for applications on <span style="color: gray;">insert date</span>. A total of <span style="color: gray;">insert number</span> applications were received with <span style="color: gray;">insert number</span><span style="color: red;">/no candidates </span>withdrawing during the course of the exercise. <b<span style="color: red;">&lt;insert if appropriate:</span></b <span style="color: gray;">insert number</span> candidates have been shortlisted at the <span style="color: red;">[sift / qualifying test]<b&gt;</b</span></p>
          </li>
          <li>
            <p>The statutory eligibility requirements <b<span style="color: red;">&lt;insert if appropriate:</span></band ASC<b<span style="color: red;">&gt;</span></b for this exercise are at <bAnnex A </b<b<span style="color: red;">&lt;insert hyperlink to Annex&gt;</span></b<span style="color: red;">.</span></p>
          </li>
        </ol>
        <br>
        <p><b>Eligibility</b></p>
        ...
        <ol start="6">
          <li>
            <p>Checks were conducted and <b<span style="color: red;">&lt;insert if appropriate:</span></b allcandidates meet the statutory eligibility requirements for this exercise. <b<span style="color: red;">OR</span></b<span style="color: gray;">insert number</span> candidates did not meet the statutory eligibility requirements for this exercise. Those that do not are listed at <bAnnex <span style="color: red;">X</span></b.<b<span style="color: red;">&gt;</span></b</p>
          </li>
          <li>
            <p><b<span style="color: red;">&lt;insert if appropriate:</span></b<span style="color: gray;">insert number</span> candidates' statutory eligibility was considered by the Lord Chancellor under <b<span style="color: red;">&lt;insert as appropriate: </span></b<span style="color: red;">s.52(4)(i) of/para 1(2)(d) of Schedule 2/3 to<b&gt;</b</span> the Tribunals, Courts and Enforcement Act 2007. <span style="color: gray;">insert number</span> were deemed ineligible by the Lord Chancellor and are now listed at <bAnnex <span style="color: red;">X</span></bfor information purposes.<b<span style="color: red;">&gt;</span></b</p>
          </li>
        </ol>
        <br>
        <p><b<span style="color: red;">&lt;insert as appropriate: </span></b<bAdditional Selection Criteria </b<b<span style="color: red;">[<em>Criteria/Criterion</em>]</span></b</p>
        <br>
        <ol start="8">
          <li>
          ...
          <br>
          <li>
            <p>The Lord Chancellor has also provided ASC that </p>    
          </li>
          <br>
          <li>
            <p><b>Annex X</b>. lists candidates who are considered not to meet the ASC but are recommended to proceed, and/or are considered to have demonstrated the necessary skills in some other significant way. <span style="color: red;">&lt;Amend as required depending on the circumstances.</span> The SCC needs to be consulted on all those candidates for which a decision for them to proceed needs to be agreed. This includes, but is not limited to, candidates on whom the panel could not make a definitive decision; candidates who fall short of the reasonable length of service but are recommended to proceed due to business need; candidates who fall short of the PJE requirement but have demonstrated that it will be met in the near future; candidates whose PJE is quasi-judicial; and candidates who are considered to indirectly meet the ASC because they have demonstrated the necessary skills in some other significant way. This could require additional annexes depending on the circumstances once candidates are grouped together</p>
          </li>
          <li>
            <p><b>Annex X</b>. lists candidates who are considered not to meet the ASC and are not recommended to proceed.</p>
          </li>
        </ol>
        <br>
        <p><b>Reasonable Length of Service</b></p>
        <br>
        <ol start="12">
          <li>
            <p><span style="color: #242424;">The Lord Chancellor expects candidates to be able to offer a reasonable length of service following recommendation for appointment and before retirement. Following the Public Service Pensions and Judicial Office Act 2022 receiving Royal Assent on 10 March 2022, the mandatory retirement age is 75. The age at which someone is appointed to this office must allow for a reasonable length of service before retirement, usually for this position</span><span style="color: gray;"> insert number</span><span style="color: #242424;"> years.</span><b<span style="color: red;"> &lt;insert if all candidates meeting the RLoS&gt; </span></bAll candidates meet the reasonable length of service criterion.</p>
          </li>
          <li>
            <p>
              <b>Annex X</b>. lists the candidate <span style="color: red;">(s) </span>whose age <span style="color: red;">(s)</span> do <span style="color: red;">(es)</span> not allow for this reasonable length of service before retirement.
            </p>
          </li>
        </ol>
        <br>
        ...
        <br>
        <br>
        <p style="">Selection Exercise Manager</p>
      </div>
    `);
    ...
    writer.addRaw(`
      <div style="font-family: 'Arial'; font-size: 11pt;">
        ...
        <p style="text-align: center;"><b>JUDICIAL APPOINTMENTS ELIGIBILITY STATEMENT AND ASC</b></p>
        <br>
        <p><b>Title:</b> ${exercise.name}</p>
        <br>
        <p><b>Statutory eligibility requirement:</b></p>
        <br>
        <p><b>Relevant qualification:</b> ${exercise.qualifications.join(', ')}</p>
        <br>
        <p><b>Non-statutory eligibility requirement</b></p>
        <p><b>Approved by Lord Chancellor (N/A):</b></p>
        <br>
        <p><b>Additional Information:</b></p>
        <br>
        <p><b>Reasonable length of service (and retirement age if not 70*):</b></p>
        <p><b>*As set out in the government response to the Judicial Mandatory Retirement Age consultation published on 8 March, it is the intention to raise the mandatory retirement age (MRA) for judicial holders to 75.</b> - ${exercise.reasonableLengthService} ${exercise.reasonableLengthService > 1 ? 'years' : 'year'}</p>
        <br>
        <p><b>Salaried posts only:</b></p>
        <p><b>Previous service in judicial office</b>:</p>
        <br>
        <p><b>House of Commons Disqualification Act 1975 applies:</b></p>
        <br>
        <p><b>Salaried posts only:</b></p>
        <p><b>Medical Examination:</b></p>
      </div>
    `);
  ...
  function addNewHtmlPage() {
    return `
      <hr class="pb">
      <p style="font-family: Arial; font-size: 10pt; text-align: center;"><b>OFFICIAL - SENSITIVE</b></p>
      <p style="font-family: Arial; font-size: 10pt; text-align: right;"><b>(JAC/SCC/xx/xxx)</b></p>
      <br>
    `;
  }
